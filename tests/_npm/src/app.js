...
// import Dashboard from '@uppy/dashboard'                              // + (just surface | f t/sh) 189 imports (381kb) - 47-59ms (w/o t/s == 46) vs 105ms (f/ts - ~98ms)
...
// import { http, HttpResponse } from 'msw'                                // + 46 imports (68kb) - ~48ms vs 47ms (neo w tree-sh, w f t/s - 44 ms)
