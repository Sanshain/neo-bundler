...
import Dashboard from '@uppy/dashboard'                                 // + (just surface | f t/sh) 189 imports (381kb) - 47-59ms (w/o t/s == 46) vs 100ms (f/ts - ~95ms)
// import { javascript } from "@codemirror/lang-javascript";               // + (just surface | w/o t/sh) 22 imports (1038kb) - ~71ms (w/o t/s == 71) vs 79ms (neo w j f tree-sh, w/o - ~67ms)
// import { basicSetup, EditorView } from "codemirror"                     // + (just surface | w/o t/sh) 31 imports (1037kb) ~72ms vs 90ms (f/ts) (w/o t/sh - 65ms)
// import { http, HttpResponse } from 'msw'                             // + 46 imports (68kb) - ~48ms vs 47ms (neo w tree-sh, w f t/s - 40 ms)
// import { tokensToFunction } from "path-to-regexp";

// import Swiper from 'swiper';
// import { Navigation, Pagination } from 'swiper/modules';              // + 35 imports (170kB) - 29ms vs 29ms (f/ts)
