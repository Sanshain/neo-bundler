...
// import Dashboard from '@uppy/dashboard'                                 // + (just surface | f t/sh) 189 imports (381kb) - 47-59ms (w/o t/s == 46) vs 70/77/100ms (f/ts - ~74/69/95ms)
// import { javascript } from "@codemirror/lang-javascript";               // + (just surface | w/o t/sh) 22 imports (1038kb) - ~71ms (w/o t/s == 71) vs 73/74/79ms (neo w j f tree-sh, w/o - ~61/65/67ms)
...
// import { http, HttpResponse } from 'msw'                                   // + 46 imports (68kb) - ~48ms vs 47ms (neo w tree-sh, w f t/s - 33/34/40 ms)
// import { tokensToFunction } from "path-to-regexp";

// import Swiper from 'swiper';
// import { Navigation, Pagination } from 'swiper/modules';              // + 35 imports (170kB) - 27/29ms vs 27/29ms (f/ts)
